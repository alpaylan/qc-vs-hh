...
mmap
  = [(("Correct", "InsertValid"), sample_InsertValid),
     (("Correct", "DeleteValid"), sample_DeleteValid),
     (("Correct", "UnionValid"), sample_UnionValid),
     (("Correct", "InsertPost"), sample_InsertPost),
     (("Correct", "DeletePost"), sample_DeletePost),
     (("Correct", "UnionPost"), sample_UnionPost),
     (("Correct", "InsertModel"), sample_InsertModel),
     (("Correct", "DeleteModel"), sample_DeleteModel),
     (("Correct", "UnionModel"), sample_UnionModel),
     (("Correct", "InsertInsert"), sample_InsertInsert),
     (("Correct", "InsertDelete"), sample_InsertDelete),
     (("Correct", "InsertUnion"), sample_InsertUnion),
     (("Correct", "DeleteInsert"), sample_DeleteInsert),
     (("Correct", "DeleteDelete"), sample_DeleteDelete),
     (("Correct", "DeleteUnion"), sample_DeleteUnion),
     (("Correct", "UnionDeleteInsert"), sample_UnionDeleteInsert),
     (("Correct", "UnionUnionIdem"), sample_UnionUnionIdem),
     (("Correct", "UnionUnionAssoc"), sample_UnionUnionAssoc)]